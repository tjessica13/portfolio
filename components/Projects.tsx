...
const Projects = () => {
    return (
        <div className="py-20 relative" id="Projects"> 
            <h1 className="heading mt-20 text-black dark:text-white">
        ...
        <div className="w-full mt-2">
            ...
            <button className="rounded-full pl-2 pr-2 py-2 text-purple flex items-center space-x-1 bg-black mt-4 text-xs font-bold dark:bg-zinc-800">
            <span>Read more</span>
            </button>
